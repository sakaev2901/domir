  ...
  methods: {
    ...
    connect() {
      ...
      this.stompClient.connect(
        ...
        frame => {
          console.log(frame);
          this.stompClient.subscribe("/chat/" + this.id, tick => {
    ...
    sendMessage() {
      if (this.content !== "") {
        // this.$store.dispatch('sendMessage', { username: this.username, content: this.content, chatName: this.id })
         const msg = {
